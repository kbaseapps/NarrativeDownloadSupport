SERVICE = narrativedownloadsupport
SERVICE_CAPS = NarrativeDownloadSupport
SPEC_FILE = NarrativeDownloadSupport.spec
URL = https://kbase.us/services/narrativedownloadsupport
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
